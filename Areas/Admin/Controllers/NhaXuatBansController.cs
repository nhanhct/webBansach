...
namespace BaiNopCuoiKi7.Areas.Admin.Controllers
{
    public class NhaXuatBansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNXB,TenNXB,DiaChi,SDT")] NhaXuatBan nhaXuatBan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNXB,TenNXB,DiaChi,SDT")] NhaXuatBan nhaXuatBan)
        {
            if (ModelState.IsValid)
            {
